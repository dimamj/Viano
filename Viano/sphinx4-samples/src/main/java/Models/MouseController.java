...
public class MouseController extends AbstractController {
    ...
    /*
    Данный поток запускается при активации движения курсора,
    слушает речь с микрофона и передает результат главному потоку,
    пока главный поток в цикле осуществляет движение курсора
     */
